...
import { Card, ServiceIcon, Modal, MediaUpload, notify } from '../components/shared';
...
export default function GuaranteePage() {
  ...
  async function submit() {
    ...
    try {
      await api.post('/guarantee', { bookingId: openFor.id, description: desc.trim(), mediaUrls });
      ...
      {openFor && (
        ...
        >
          ...
          <textarea
            ...
            style={{ fontSize: 14 }}
          />
          <p className="mt-3" style={{ color: COLOR_TEXT_SECONDARY, fontSize: 13, fontWeight: 600 }}>صور المشكلة (اختياري)</p>
          <div className="mt-2">
            <MediaUpload value={mediaUrls} onChange={setMediaUrls} purpose="guarantee_evidence" />
          </div>
