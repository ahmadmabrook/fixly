  ...
  return (
    <main className="max-w-[800px] mx-auto px-6 py-10">
      <div className="flex items-center gap-2">
        <LifeBuoy size={26} color="#1366D6" aria-hidden="true" />
        <h1 style={{ fontWeight: 800, fontSize: 28 }}>مركز المساعدة</h1>
      </div>
      <p className="mt-2" style={{ color: '#475569', fontSize: 14 }}>الأسئلة الأكثر شيوعاً حول الحجز والدفع والضمان.</p>
      ...
      <Card className="mt-6 p-5 flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <div style={{ color: '#475569', fontSize: 13 }} className="mt-1">افتح تذكرة دعم وسنرد خلال 5 دقائق.</div>
        </div>
        <button
