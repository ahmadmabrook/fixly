...
export default function Quotes() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 style={{ fontSize: 22, fontWeight: 800, color: COLOR_TEXT_PRIMARY }}>طلبات الفحص المرئي</h1>
        <p style={{ fontSize: 13, color: COLOR_TEXT_MUTED, marginTop: 2 }}>راجع فيديو المشكلة وحدّد سعراً ثابتاً — يصبح سعر الحجز عند القبول.</p>
      </div>
